...
public class AbraPokeballBlock extends BlockWithEntity implements BlockEntityProvider {

    public static final MapCodec<AbraPokeballBlock> CODEC = createCodec(AbraPokeballBlock::new);
    ...
    public AbraPokeballBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new AbraEntity(pos, state);
    }
