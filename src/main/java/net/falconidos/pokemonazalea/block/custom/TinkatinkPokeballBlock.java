...
import net.falconidos.pokemonazalea.block.entity.custom.TinkatinkEntity;
...
public class TinkatinkPokeballBlock extends BlockWithEntity implements BlockEntityProvider {

    public static final MapCodec<TinkatinkPokeballBlock> CODEC = createCodec(TinkatinkPokeballBlock::new);
    ...
    public TinkatinkPokeballBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new TinkatinkEntity(pos, state);
    }
