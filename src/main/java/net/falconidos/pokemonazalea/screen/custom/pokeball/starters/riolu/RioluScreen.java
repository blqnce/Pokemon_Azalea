package net.falconidos.pokemonazalea.screen.custom.pokeball.starters.riolu;
...
public class RioluScreen extends HandledScreen<RioluScreenHandler> {

    private Button accept,reject;

    private String pokemon = "riolu";

    public RioluScreen(RioluScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.RIOLU);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.RIOLU, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
