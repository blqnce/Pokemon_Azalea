package net.falconidos.pokemonazalea.screen.custom.pokeball.starters.gastly;
...
public class GastlyScreen extends HandledScreen<GastlyScreenHandler> {

    private Button accept,reject;

    private String pokemon = "gastly";

    public GastlyScreen(GastlyScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.GASTLY);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.GASTLY, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
