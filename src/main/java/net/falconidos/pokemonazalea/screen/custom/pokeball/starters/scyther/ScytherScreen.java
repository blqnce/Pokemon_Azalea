package net.falconidos.pokemonazalea.screen.custom.pokeball.starters.scyther;
...
public class ScytherScreen extends HandledScreen<ScytherScreenHandler> {

    private Button accept,reject;

    private String pokemon = "scyther";

    public ScytherScreen(ScytherScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.SCYTHER);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.SCYTHER, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
