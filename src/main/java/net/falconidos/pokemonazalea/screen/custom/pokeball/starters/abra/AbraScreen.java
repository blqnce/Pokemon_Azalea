...
public class AbraScreen extends HandledScreen<AbraScreenHandler> {

    private Button accept,reject;

    private String pokemon = "abra";

    public AbraScreen(AbraScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.ABRA);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.ABRA, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
