...
public class ApplinScreen extends HandledScreen<ApplinScreenHandler> {

    private Button accept,reject;

    private String pokemon = "applin";

    public ApplinScreen(ApplinScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.APPLIN);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.APPLIN, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
