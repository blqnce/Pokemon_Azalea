...
public class NacliScreen extends HandledScreen<NacliScreenHandler> {

    private Button accept,reject;

    private String pokemon = "nacli";

    public NacliScreen(NacliScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.NACLI);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.NACLI, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
