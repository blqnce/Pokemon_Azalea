...
public class ElekidScreen extends HandledScreen<ElekidScreenHandler> {

    private Button accept,reject;

    private String pokemon = "elekid";

    public ElekidScreen(ElekidScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.ELEKID);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.ELEKID, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
