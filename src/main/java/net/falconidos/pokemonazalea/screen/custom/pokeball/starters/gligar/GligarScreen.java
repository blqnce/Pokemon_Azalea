package net.falconidos.pokemonazalea.screen.custom.pokeball.starters.gligar;
...
public class GligarScreen extends HandledScreen<GligarScreenHandler> {

    private Button accept,reject;

    private String pokemon = "gligar";

    public GligarScreen(GligarScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.GLIGAR);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.GLIGAR, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
