...
public class SprigatittoScreen extends HandledScreen<SprigatittoScreenHandler> {

    private Button accept,reject;

    private String pokemon = "sprigatitto";

    public SprigatittoScreen(SprigatittoScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.SPRIGATITTO);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.SPRIGATITTO, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
