...
public class MunchlaxScreen extends HandledScreen<MunchlaxScreenHandler> {

    private Button accept,reject;

    private String pokemon = "munchlax";

    public MunchlaxScreen(MunchlaxScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.MUNCHLAX);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.MUNCHLAX, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
