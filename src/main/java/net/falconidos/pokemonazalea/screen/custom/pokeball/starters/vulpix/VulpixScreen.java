...
public class VulpixScreen extends HandledScreen<VulpixScreenHandler> {

    private Button accept,reject;

    private String pokemon = "vulpix";

    public VulpixScreen(VulpixScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.VULPIX);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.VULPIX, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
