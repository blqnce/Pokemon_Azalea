...
public class TinkatinkScreen extends HandledScreen<TinkatinkScreenHandler> {

    private Button accept,reject;

    private String pokemon = "tinkatink";

    public TinkatinkScreen(TinkatinkScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.TINKATINK);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.TINKATINK, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
