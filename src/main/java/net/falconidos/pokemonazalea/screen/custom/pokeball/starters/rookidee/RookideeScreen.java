...
public class RookideeScreen extends HandledScreen<RookideeScreenHandler> {

    private Button accept,reject;

    private String pokemon = "rookidee";

    public RookideeScreen(RookideeScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.ROOKIDEE);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.ROOKIDEE, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
