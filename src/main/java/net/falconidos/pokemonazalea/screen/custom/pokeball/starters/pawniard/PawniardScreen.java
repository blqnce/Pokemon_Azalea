...
public class PawniardScreen extends HandledScreen<PawniardScreenHandler> {

    private Button accept,reject;

    private String pokemon = "pawniard";

    public PawniardScreen(PawniardScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.PAWNIARD);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.PAWNIARD, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
