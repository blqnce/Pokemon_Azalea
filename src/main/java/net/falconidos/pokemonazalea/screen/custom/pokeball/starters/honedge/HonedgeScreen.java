package net.falconidos.pokemonazalea.screen.custom.pokeball.starters.honedge;
...
public class HonedgeScreen extends HandledScreen<HonedgeScreenHandler> {

    private Button accept,reject;

    private String pokemon = "honedge";

    public HonedgeScreen(HonedgeScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.HONEDGE);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.HONEDGE, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
