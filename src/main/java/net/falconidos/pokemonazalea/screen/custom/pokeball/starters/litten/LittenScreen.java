...
public class LittenScreen extends HandledScreen<LittenScreenHandler> {

    private Button accept,reject;

    private String pokemon = "litten";

    public LittenScreen(LittenScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, ModGuiTextures.LITTEN);
        int x = (width - backgroundWidth) / 2;
        int y = (height - backgroundHeight) / 2;

        context.drawTexture(ModGuiTextures.LITTEN, x, y, 0, 0, backgroundWidth, backgroundHeight);
    }
